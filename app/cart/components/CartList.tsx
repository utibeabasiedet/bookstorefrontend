...
const CartList = () => {
  ...
  return (
    <div className="flex justify-between p-4">
      ...
      <div className="w-[65vw]">
        ...
        <ul className="space-y-4">
          {cartItems.length === 0 ? (
            ...
            cartItems.map((book) => (
              <li key={book._id} className="flex items-center justify-between bg-white p-4 shadow-md">
                <div className="flex items-center space-x-4">
                  {book.image && (
                    <Image src={book.image} alt={book.title} width={80} height={100} />
                  )}
                  <div>
      ...
      <div className="w-[30vw] bg-gray-100 p-6 shadow-lg rounded-lg">
